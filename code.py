...
root.title("Encryption and Decryption using Vignere Cipher")
...
lblMsg = Label(f1, font=('arial', 16, 'bold'),
               text="PLAIN / ENCRYPTED TEXT : ", bd=16, anchor="w")
...
lblmode = Label(f1, font=('arial', 16, 'bold'),
                text="MODE (e TO ENCRYPT, d TO DECRYPT) : ",
                bd=16, anchor="w")
